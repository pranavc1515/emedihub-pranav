...
const TeamSection = () => {
  return (
    ...
    <p className="text-[#3C4959] text-[18px] font-[400] mx-auto w-[800px]">
      The visionary leaders guiding our mission, shaping the future, and driving strategic decisions. 
      Their expertise and leadership ensure our growth, innovation, and long-term success.
    </p>
