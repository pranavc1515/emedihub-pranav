  ...
  return (
    ...
    <div className="container mx-auto flex justify-center items-center h-full flex-col md:flex-row  md:items-start">
      ...
      <div className="hidden md:block w-1/4 pt-8">
        <img src={TresImages} alt="Tree Illustration" className="w-full xl:h-[407px]" />
      </div>
      ...
      <div className="flex flex-col space-y-6  text-[20px] text-[#E1E1E1] font-semibold pt-[20px]">
          <a href="#" className="hover:text-gray-400">Abouts</a>
          ...
          <a href="#" className="hover:text-gray-400">Contacts</a>
        </div>
        <div className="flex flex-col space-y-6 text-[20px] text-[#E1E1E1] font-semibold pt-[20px]">
      ...
      <a href="#" className="">
        <img src={X} alt="Close" className="w-[40px] h-[40px]" />
      </a>
    </div>
      </div>
      ...
      <div className="flex flex-col items-center md:w-1/4 mt-6 md:mt-0 pt-[80px] ">
        <h3 className="text-[20px] font-semibold text-[#E1E1E1] mb-3">Download Application</h3>
        <div className="flex space-x-9">
          <img src={playStore} alt="Play Store" className="w-[60px] h-[60px]" />
          <img src={AppleStore} alt="App Store" className="w-[60px] h-[60px]" />
        </div>
        
        {/* Company Logo */}
        <img src={eMediHubLogo} alt="eMediHub Logo" className="w-[133px] h-[93px] mt-4" />
      </div>
    </div>
